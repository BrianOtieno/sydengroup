...
import { TodoListComponent } from '../projects/TodoList';
...
const Dashboard = () => {
  ...
  // const [loggedInFirstName] = useContext(UserContext);
  // const [loggedInLastName] = useContext(UserContext);
      ...
      <div>
        <div className="proBanner">
          <div>
            <span className="d-flex align-items-center purchase-popup">
              <p> You can now use our platform to manage your project!</p>
              <a href="#" rel="noopener noreferrer" target="_blank" className="btn btn-sm purchase-button ml-auto">Update To Pro Version</a>
              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    <h4 className="mb-1 mb-sm-0">Get it out of the way!</h4>
                    <p className="mb-0 font-weight-normal d-none d-sm-block">The fastest and easiest way to check your requirements for compliance.</p>
                  </div>
          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Total Compliances Queried </h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-9">
                    <div className="d-flex align-items-center align-self-start">
                      <h3 className="mb-0">65,000</h3>
                      <p className="text-success ml-2 mb-0 font-weight-medium">+10%</p>
                    </div>
                  </div>
                  <div className="col-3">
                    <div className="icon icon-box-success">
                ...
                <h6 className="text-muted font-weight-normal">Compliances in Past Month</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Compliances in Past 24Hrs</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">My Compliances</h6>
              </div>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Top Queried Regulation Authority</h4>
                ...
                <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                  <div className="text-md-center text-xl-left">
                    <h6 className="mb-1">FRB</h6>
                    <p className="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                  </div>
                  <div className="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                    <h6 className="font-weight-bold mb-0">120,000</h6>
                  </div>
                </div>
                <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                  <div className="text-md-center text-xl-left">
                    <h6 className="mb-1">SEC</h6>
                    <p className="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                  </div>
                  <div className="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                    <h6 className="font-weight-bold mb-0">86,000</h6>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex flex-row justify-content-between">
                  <h4 className="card-title mb-1">My Projects</h4>
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Recent News</h4>
